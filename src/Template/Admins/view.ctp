							...
							<form class="form-horizontal" role="form" method="post" action="">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="password" class="form-control" placeholder="Enter Current Password" id="name" name="name" >
											<!-- <span class="help-block text-danger"> A block of help text. </span> -->
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="password" class="form-control" placeholder="Enter New Password" id="name" name="name" >
											<!-- <span class="help-block text-danger"> A block of help text. </span> -->
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="password" class="form-control" placeholder="Enter Confirm Password" id="name" name="name" >
											<!-- <span class="help-block text-danger"> A block of help text. </span> -->
										</div>
									</div>
								</div>
